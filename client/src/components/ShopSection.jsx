    ...
    <section className="bg-white px-4 py-20 text-zinc-900 dark:bg-black dark:text-white">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex items-end justify-between">
          <div>
            <h2 className="text-4xl font-black md:text-5xl">Boutique Picks</h2>
            <p className="mt-2 text-zinc-600 dark:text-zinc-400">Curated pieces you’ll love</p>
          </div>
          <button
            onClick={() => navigate('/shop')}
            className="hidden text-sm font-bold text-zinc-900 hover:text-[#9F2B68] dark:text-white md:block"
          >
            View All →
          </button>
        </div>
