...
const styleLooks = [
  {
    ...
    name: "Zara A.",
    handle: "@zara.styles",
    quote: "This MIZ J set is everything. Dress it up or down — I've worn it 5 ways already.",
  ...
  },
  {
    ...
    name: "Kwesi M.",
    handle: "@kwesi.fits",
    quote: "Quality is insane for the price. The fit is exactly like the photos.",
  ...
  },
  {
    ...
    name: "Naa D.",
    handle: "@naa.daily",
    quote: "Finally found pieces that actually fit my body. Running back for more colors.",
...
export default function StyleCarousel() {
  ...
  return (
    <section className="bg-neutral-50 px-4 py-20 text-zinc-900 dark:bg-zinc-950 dark:text-white">
      ...
      >
        <div>
          <p className="mb-2 text-sm uppercase tracking-[0.3em] text-[#9F2B68]">Community</p>
          <h2 className="mb-4 text-4xl font-bold tracking-tight md:text-5xl">MIZ J Muses</h2>
          <p className="mb-12 text-zinc-600 dark:text-zinc-400">
            Tag @mizjboutique to be featured
          </p>
        </div>
              ...
              <div className="grid h-full md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center bg-white p-6 text-left dark:bg-zinc-900 sm:p-8">
                  ...
                  <div className='mb-5'>
                    ...
                    <p className="text-sm text-[#9F2B68]">{t.handle}</p>
                  </div>
                  {t.productId && (
                    <button
                      className='w-fit text-sm font-semibold underline hover:text-[#9F2B68]'
        ...
        <button
          onClick={() => window.open('https://instagram.com/mizjboutique', '_blank')}
