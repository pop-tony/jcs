                ...
                {cartItems.length === 0? (
                  <div className="flex h-full flex-col items-center justify-center text-center py-20">
                    ...
                    <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                      Add some MIZ J pieces to get started
                    </p>
                    <button
                    ...
                    {cartItems.map((item) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="cursor-pointer mt-3 flex w-full items-center justify-center gap-2 rounded-full border-2 border-[#9F2B68] py-2.5 text-sm font-semibold text-[#9F2B68] transition hover:bg-[#9F2B68] hover:text-white active:scale-95"
                        >
            ...
            <>
              <div className="flex-1 overflow-y-auto p-6">
                <form className="space-y-4">
                  <div className="rounded-2xl border border-[#9F2B68]/20 bg-[#9F2B68]/10 p-4 dark:border-[#9F2B68]/20 dark:bg-[#9F2B68]/10">
                    <p className="text-sm font-semibold text-[#9F2B68] dark:text-[#C9376E]">
                      {checkoutItems.length === 1? checkoutItems[0].name : `${checkoutItems.length} items`}
                    </p>
                    {checkoutItems.length === 1 && checkoutItems[0].size && (
                      <div className="mt-1 flex gap-3 text-xs text-[#9F2B68]/80 dark:text-[#C9376E]/80">
                        <span>Size: {checkoutItems[0].size}</span>
                        <span>Qty: {checkoutItems[0].quantity}</span>
                      </div>
                    )}
                    <p className="mt-2 text-lg font-bold text-[#9F2B68] dark:text-[#C9376E]">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-3 text-zinc-900 outline-none focus:border-[#9F2B68] focus:ring-4 focus:ring-[#9F2B68]/10 dark:border-white/10 dark:bg-zinc-900 dark:text-white"
