      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-8 text-zinc-700 dark:text-zinc-300">
          <section>
            ...
            <p>
              By accessing or purchasing from Jad's Collection Shop (JCS), you agree to be bound by these 
          ...
          <section>
            ...
            <p>
              Product colors may vary slightly due to screen differences. Refer to our size guide before 
              purchasing. All measurements are approximate.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              errors in pricing, or suspected fraud. If we cancel your order after charge, you will receive a full refund.
            </p>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-2xl font-bold text-zinc-900 dark:text-white">5. Returns & Exchanges</h2>
            <p className="mb-2">
              Returns accepted within 7 days of delivery if items are unworn, unwashed, and in original packaging 
              with tags attached. Sale items are final and non-returnable.
            </p>
            <p>
              Refunds are issued to the original payment method within 5-10 business days after we receive and 
              inspect the return. Customer is responsible for return shipping costs unless the item was defective 
          ...
          <section>
            ...
            <p>
              All content on this site, including designs, logos, text, images, and the JCS brand, 
              is our property and protected by copyright. You may not reproduce or distribute without permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              JCS is not liable for any indirect, incidental, or consequential damages arising from use of our 
              products or website. Our total liability shall not exceed the amount paid for the product in question.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Questions about these Terms? Email us at <span className="font-semibold text-[#9F2B68]">legal@jcsboutique.com</span> or 
              WhatsApp <span className="font-semibold">+233 59 822 7146</span>.
            </p>
          </section>
        </div>
      </div>
